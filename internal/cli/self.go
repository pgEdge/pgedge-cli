...
update refuses to touch a Homebrew or npm install, or a binary inside
a git working tree — run 'brew upgrade pgedge', 'npm install -g
@pgedge/cli@latest' or 'make build' instead.
...
func runSelfUpdate(
	...
	// (a Homebrew or npm install, a binary inside a git working tree) fails
