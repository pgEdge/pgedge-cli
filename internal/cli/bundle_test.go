...
// signBundle is internal/selfupdate's helper of the same name, copied
// because a _test.go file cannot be imported and a non-test package
// would put the test CA's dependencies into NOTICE.txt.
//
// It signs payload as identity/issuer with the virtual CA and
